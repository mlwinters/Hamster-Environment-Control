...
os.system("sudo chmod 757 /home/pi/Hamster-Environment-Control/hec-status.ini")
#

# Set hec-config File Permissions #
os.system("sudo chmod 757 /home/pi/Hamster-Environment-Control/hec-config.ini")
#
